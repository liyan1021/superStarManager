...
@Entity
@Table(name="vod_store_new_music_ranking")
public class NewMusicRanking implements Serializable{
	...
	@Column(name="music_song_number")
	private String music_song_number ;
	...
	public String getMusic_song_number() {
		return music_song_number;
	}
	public void setMusic_song_number(String music_song_number) {
		this.music_song_number = music_song_number;
	}
