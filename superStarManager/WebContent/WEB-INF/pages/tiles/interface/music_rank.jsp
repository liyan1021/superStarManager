...
<script type="text/javascript">
	$(function () {
	    $('#tt').datagrid({
			...
			fit:true ,
		    pagination : true,
		    url:'musicRankingList.action',
		    method: 'post',
		   	toolbar: "#toolbar",
		   	sortName : "music_all_song_number",
		   	sortOrder: "desc",
			columns:[[
				{field:'music_name',title:'歌曲',width:150},
				{field:'singer_name',title:'歌星',width:150},
				{field:'music_all_song_number',title:'总点唱次数',width:150,sortable: true},
				{field:'music_month_song_number',title:'月点唱次数',width:150,sortable: true},
				{field:'music_year_song_number',title:'年点唱次数',width:150,sortable: true},
				
			]],
			onDblClickCell:function(rowIndex, field, value){
				if(field == 'music_all_song_number'){
